    ...
    <div className="space-y-8 pb-24 md:pb-8">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">AI-powered property discovery</p>
        </div>

        <AISearch properties={properties} onResults={setAiFilteredIds} />
      ...
      {/* Featured Section */}
      {!aiFilteredIds && featuredProperties.length > 0 && (
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">
            {aiFilteredIds ? 'AI Recommended for You' : 'Recent Listings'}
          </h2>
          {aiFilteredIds && (
            <span className="flex items-center gap-1 text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full uppercase tracking-wider">
